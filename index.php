  ...
  <?php if (have_posts()) : ?>
		<?php while (have_posts()) : the_post(); ?>
			<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
				<div class="post-sum"> <h2><a href="<?php the_permalink() ?>" rel="bookmark" class="posttitle" title="<?php _e('Permanent Link to','pts'); ?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
				<small><?php _e('Posted','pts'); ?>: <?php the_time('F jS, Y') ?> <!-- by <?php the_author() ?> --></small></div>
				<div class="entry">
